    ...
    return (
        <div className="about ">
            <div className="texted">
                ...
                <br />
                <p>It's Now become very neccessary to have a good knowledge of what is happening in the world day by day.<b><i> The RSP News</i></b> presents top 20 News of the day. <b><i> The RSP News Chennel</i></b> launched in June' 2021. The channel is designed using the ReactJs Framework and is operated by <b><i> Mr. Raspreet Singh Pasrija.</i></b></p>
                <br />
                <h6>Mr. Raspreet Singh Pasrija words :</h6>
                <p><b><i> The RSP News Chennel</i></b> is the first API based Project. I designed <b><i> The RSP News Chennel</i></b> in 2 days only and one of my friend <b><i> Aman Mahore </i></b> helped me when I'm facing some issues with my project <b><i> The RSP News Chennel.</i></b> This is just an start to the way of becoming an Web Developer. </p>
                <br />
